...
int LONG_PRESSED_INTERVALtimer1_counter = COUNT_RESET;
int LONG_PRESSED_INTERVALtimer1_flag = FLAG_OFF;

int LONG_PRESSED_INTERVALtimer2_counter = COUNT_RESET;
int LONG_PRESSED_INTERVALtimer2_flag = FLAG_OFF;
